...
/**
 * Mete plush – plays the "mete_plush" sound.
 */
public class MetePlushBlock extends AbstractPlushBlock {

    public MetePlushBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
