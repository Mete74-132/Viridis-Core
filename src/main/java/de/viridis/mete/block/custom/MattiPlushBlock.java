...
/**
 * Matti plush – plays the "matti_plush" sound.
 */
public class MattiPlushBlock extends AbstractPlushBlock {

    public MattiPlushBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
